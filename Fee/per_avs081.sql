...
curl -X GET http://131.116.44.144:1316/services/SYSIBMSERVICE/per_avs081/V1 -H "Content-Type: application/json" -u a472inb:INblatS2 | jq


curl -X POST \
http://131.116.44.144:1316/services/SYSIBMSERVICE/per_avs081/V1 \
