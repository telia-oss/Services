...
curl -X POST \
http://131.116.44.152:1317/services/SYSIBMSERVICE/des01/V1 \
...
curl -X POST \
http://131.116.44.152:1317/services/SYSIBMSERVICE/pp0001/V1 \
-H 'accept: application/json'   \
-H 'Content-Type: application/json' \
-u a472inb:INblatS2 \
-d '{
...
curl -X GET http://131.116.44.152:1317/services/SYSIBMSERVICE/des01/V1 -H "Content-Type: application/json" -u a472inb:INblatS2 | jq
