...

{
  ...
  "username": "a472inb",
  "password": "INblatS2",
  "sqlStmt": "SELECT A.INTVL_START_DATE, A.INTVL_STOP_DATE, A.BEGIN_POINT_VL, A.END_POINT_VL, A.POINT_VL_LEN FROM STHDSN5.ITSACC.SLCT_DEST_DATA A, STHDSN5.ITSACC.CUST_ID_HIST_DATA B WHERE CAST(B.CUST_ID AS BIT FOR VARCHAR(14))=:CUST_ID AND A.CUST_PARTN_ID = B.CUST_PARTN_ID AND A.SBSCT_CUST_OID = B.CUST_OID AND A.SBSCT_ID =:SBSCT_ID ORDER BY INTVL_START_DATE DESC",
  "collectionID": "SYSIBMSERVICE",
  "serviceName": "des01",
  "owner": "COMINAT5",
  "validate": "BIND",
...
curl -X POST \
http://131.116.44.144:1315/services/SYSIBMSERVICE/des01/V1 \
...
curl -X POST \
http://131.116.44.144:1315/services/SYSIBMSERVICE/pp0001/V1 \
-H 'accept: application/json'   \
-H 'Content-Type: application/json' \
-u a472inb:INblatS2 \
-d '{
...
curl -X GET http://131.116.44.144:1315/services/SYSIBMSERVICE/des01/V1 -H "Content-Type: application/json" -u a472inb:INblatS2 | jq
