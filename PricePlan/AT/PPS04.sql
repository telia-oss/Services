...
curl -X GET http://131.116.44.144:1315/services/SYSIBMSERVICE/pps04/V1 -H "Content-Type: application/json" -u a472inb:INblatS2 | jq
...
-d '{
"requestType": "createService",
"sqlStmt": "SELECT  A.INTVL_START_DATE  FROM STHDSN5.ITSACC.CNUM_UPPS_DATA A  WHERE A.SBSCT_CUST_OID=:SBSCT_CUST_OID",
"collectionID": "SYSIBMSERVICE",
"serviceName": "pps04",
"description": "pps04 based on   CUST_ID  AND SBSCT_ID"
}'
